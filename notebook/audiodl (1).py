...
cailuong_test = ["/content/drive/MyDrive/DATA/test_audio/TinhSuBachThuHa-CAILUONG.mp3",
...
chauvan_test = ["/content/drive/MyDrive/DATA/test_audio/CoChin-ThanhNgoanKhacTu-CHAUVAN.mp3",
                "/content/drive/MyDrive/DATA/test_audio/QuanDeNhat-VanChuong-2815994.mp3",
                "/content/drive/MyDrive/DATA/test_audio/ThinhMauVaQuanDeNhat-CHAUVAN.mp3",
                "/content/drive/MyDrive/DATA/test_audio/VanChauLuc-VanChung_CHAUVAN.mp3",
                "/content/drive/MyDrive/DATA/test_audio/VanChauMuoi-CHAUVAN.mp3"]
predict_new(chauvan_test, best_model2, "/content/drive/MyDrive/DATA/test_images")

predict_new(chauvan_test, best_model1, "/content/drive/MyDrive/DATA/test_images")  # Not good than model 2
